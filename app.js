const backendURL = 'https://script.google.com/macros/s/AKfycbxVZQClqJJ698GsM_7VG7ulMDUjtwGvEPtjj-c4x8jKEuKLfwLZu5xhRj-uLgy8hi2d/exec';
...
async function saveAllEntries() {
  ...
  try {
    ...
    const savedCount = Number.isFinite(result?.saved) ? result.saved : entries.length;
    document.getElementById('entryStatus').textContent = `✅ ${savedCount} entries saved!`;
  } catch (err) {
